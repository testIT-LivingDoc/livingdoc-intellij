...
import info.novatec.testit.livingdoc.intellij.gui.renderer.LDTreeCellRenderer;
...
public class RepositoryViewUI extends SimpleToolWindowPanel {
    ...
    public RepositoryViewUI(Node rootTreeNode) {
        super(false);
    ...
    public void resetTree(Node newRootNode) {
